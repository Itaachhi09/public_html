...
<body>
  ...
  <script>
    ...
    function loadModule(event, page, module) {
      ...
      // Save current module and view to localStorage for persistence on refresh
      try {
    ...
    function loadDashboard(event) {
      ...
      // Clear saved module preference when user explicitly clicks Dashboard
      try {
