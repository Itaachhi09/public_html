...
<div class="main-content">
  ...
  <!-- Plan View Modal (Centered) -->
<div id="planViewModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 99999; justify-content: center; align-items: flex-start; overflow-y: auto; padding-top: 20px; padding-bottom: 20px;">
    <div style="background: white; border-radius: 8px; max-width: 900px; width: 95%; box-shadow: 0 20px 25px rgba(0,0,0,0.15); position: relative; z-index: 100000; margin: auto;">
        <!-- Modal Header -->
        <div style="display: flex; justify-content: space-between; align-items: center; padding: 2rem; border-bottom: 2px solid #e5e7eb; position: sticky; top: 0; background: white; z-index: 100001;">
            <div>
                <h2 id="viewPlanTitle" style="font-size: 1.5rem; margin: 0 0 0.25rem 0; color: #1f2937;">Plan Details</h2>
                <p id="viewPlanCode" style="margin: 0; font-size: 13px; color: #6b7280;">Code: —</p>
            </div>
            <button onclick="closeViewPlanModal()" style="background: none; border: none; font-size: 1.5rem; cursor: pointer; color: #6b7280; flex-shrink: 0; z-index: 100002; padding: 0; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">✕</button>
        </div>
        ...
        <div style="padding: 2rem; overflow-y: auto; max-height: calc(100vh - 200px); position: relative; z-index: 100000;">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2rem;">
                <!-- Provider Section -->
                <div>
                    <h4 style="margin: 0 0 1rem 0; font-size: 13px; font-weight: 700; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Provider</h4>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 13px; color: #6b7280;">Provider Name</p>
                        <p id="viewPlanProvider" style="margin: 0; font-size: 15px; font-weight: 600; color: #1f2937;">—</p>
                    </div>
                </div>

                <!-- Plan Type Section -->
                <div>
                    <h4 style="margin: 0 0 1rem 0; font-size: 13px; font-weight: 700; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Plan Type</h4>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 13px; color: #6b7280;">Classification</p>
                        <p id="viewPlanType" style="margin: 0; font-size: 15px; font-weight: 600; color: #1f2937;">—</p>
                    </div>
                </div>

                <!-- Status Section -->
                <div>
                    <h4 style="margin: 0 0 1rem 0; font-size: 13px; font-weight: 700; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Status</h4>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 13px; color: #6b7280;">Current Status</p>
                        <p id="viewPlanStatus" style="margin: 0; font-size: 15px; font-weight: 600; color: #1f2937;">—</p>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-top: 2rem;">
                <h4 style="margin: 0 0 1rem 0; font-size: 13px; font-weight: 700; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Description</h4>
                <p id="viewPlanDescription" style="margin: 0; font-size: 14px; color: #4b5563; line-height: 1.6;">—</p>
            </div>

            <!-- Premiums -->
            <div style="margin-top: 2rem;">
                <h4 style="margin: 0 0 1rem 0; font-size: 13px; font-weight: 700; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Annual Premiums</h4>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">Employee</p>
                        <p id="viewPlanAnnualEmp" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">Dependent</p>
                        <p id="viewPlanAnnualDep" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">Monthly Premium</p>
                        <p id="viewPlanMonthly" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Coverage Limits -->
            <div style="margin-top: 2rem;">
                <h4 style="margin: 0 0 1rem 0; font-size: 13px; font-weight: 700; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Coverage Limits</h4>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">Out-of-Pocket Limit</p>
                        <p id="viewPlanOOPLimit" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">Deductible</p>
                        <p id="viewPlanDeductible" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">Copay %</p>
                        <p id="viewPlanCopay" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Network -->
            <div style="margin-top: 2rem;">
                <h4 style="margin: 0 0 1rem 0; font-size: 13px; font-weight: 700; color: #1f2937; text-transform: uppercase; letter-spacing: 0.5px;">Network Coverage</h4>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">In-Network Doctors</p>
                        <p id="viewPlanDoctors" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                    <div style="padding: 1rem; background: #f9fafb; border-radius: 6px;">
                        <p style="margin: 0 0 0.5rem 0; font-size: 12px; color: #6b7280;">In-Network Hospitals</p>
                        <p id="viewPlanHospitals" style="margin: 0; font-size: 16px; font-weight: 700; color: #1f2937;">—</p>
                    </div>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 24px; padding-top: 16px; border-top: 1px solid #e5e7eb;">
                <button type="button" class="btn" onclick="closeViewPlanModal(); return false;" style="background: #e5e7eb; color: #1f2937; padding: 8px 16px; border-radius: 6px; border: none; font-weight: 500; cursor: pointer; flex: 0 0 auto;">Close</button>
                <button type="button" class="btn" onclick="editPlan(currentPlanId); return false;" style="background: #3b82f6; color: white; padding: 8px 16px; border-radius: 6px; border: none; font-weight: 500; cursor: pointer; flex: 0 0 auto;">✏️ Edit</button>
            </div>
        </div>
    </div>
</div>
...
<script>
  ...
  function viewPlanModal(planId) {
    ...
    try {
      ...
      // Try to find plan in local allPlans array first
      const plan = allPlans.find(p => p.id == planId);
      
      if (plan) {
        console.log('Plan found in allPlans array:', plan);
        populateViewPlanModal(plan);
        openViewPlanModal();
      } else {
        console.log('Plan not in allPlans, fetching from API');
        // Show loading state
        openViewPlanModal();
        document.getElementById('viewPlanTitle').textContent = 'Loading...';
        ...
        fetch(`modules/hmo/api.php?action=getPlanDetail&id=${planId}`)
          ...
          .then(data => {
            ...
            if (data.success && data.data) {
              console.log('Plan data retrieved from API:', data.data);
              populateViewPlanModal(data.data);
            } else {
              throw new Error(data.error || 'No plan data returned');
            }
          })
          .catch(error => {
  ...
  function openViewPlanModal() {
    try {
      ...
      if (modal) {
        ...
        console.log('Plan view modal opened successfully');
      } else {
        console.error('planViewModal element not found');
        alert('Error: Modal element not found');
      }
    } catch (error) {
      console.error('Error opening view plan modal:', error);
  ...
  function closeViewPlanModal() {
    try {
      ...
      if (modal) {
        ...
        console.log('Plan view modal closed');
      }
    } catch (error) {
      console.error('Error closing view plan modal:', error);
    }
  }

  function populateViewPlanModal(plan) {
    console.log('populateViewPlanModal called with:', plan);
    try {
      if (!plan) {
      ...
      setText('viewPlanTitle', plan.plan_name);
      setText('viewPlanCode', `Code: ${plan.plan_code || 'N/A'}`);
      setText('viewPlanProvider', plan.provider_name);
      setText('viewPlanType', plan.plan_type);
      setText('viewPlanStatus', (plan.is_active ? '✓ Active' : '✕ Inactive'));
      setText('viewPlanDescription', plan.description);
      setText('viewPlanAnnualEmp', formatCurrency(plan.annual_premium_per_employee));
      setText('viewPlanAnnualDep', formatCurrency(plan.annual_premium_per_dependent));
      setText('viewPlanMonthly', formatCurrency(plan.monthly_premium));
      setText('viewPlanOOPLimit', formatCurrency(plan.out_of_pocket_limit));
      setText('viewPlanDeductible', formatCurrency(plan.deductible_amount));
      setText('viewPlanCopay', (plan.copay_percentage || '0') + '%');
      setText('viewPlanDoctors', (plan.in_network_doctors || '0') + ' doctors');
      setText('viewPlanHospitals', (plan.in_network_hospitals || '0') + ' hospitals');
      
      console.log('Plan modal populated successfully');
    } catch (error) {
      console.error('Error populating view plan modal:', error);
      alert('Error: ' + error.message);
    }
  }
