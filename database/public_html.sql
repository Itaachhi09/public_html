...
--
-- Host: localhost
-- Generation Time: Mar 04, 2026 at 11:13 AM
...
INSERT INTO `bonus_incentives` (`id`, `employee_id`, `payroll_run_id`, `type`, `amount`, `description`, `created_by`, `created_at`, `updated_at`) VALUES
(2, 13, NULL, 'Incentive', 1200000.00, 'aa', 7, '2026-03-03 05:19:55', '2026-03-03 05:19:55'),
(3, 13, NULL, 'Incentive', 1200000.00, 'aa', 7, '2026-03-03 05:21:38', '2026-03-03 05:21:38');
...
INSERT INTO `deductions` (`id`, `employee_id`, `payroll_run_id`, `type`, `amount`, `description`, `created_by`, `created_at`, `updated_at`) VALUES
(3, 9, NULL, 'SSS', 2222.00, 'adad', 0, '2026-03-03 04:51:31', '2026-03-03 04:51:31');
...
CREATE TABLE `deduction_types` (
  ...
  `description` text DEFAULT NULL,
  `category` enum('government','loan','company','other') DEFAULT 'other',
...
INSERT INTO `deduction_types` (`id`, `code`, `name`, `description`, `category`, `is_mandatory`, `is_taxable`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'SSS', 'SSS Contribution', 'Social Security System', 'government', 1, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(2, 'PHIC', 'PhilHealth', 'Philippine Health Insurance', 'government', 1, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(3, 'HDMF', 'PAG-IBIG', 'Home Development Mutual Fund', 'government', 1, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(4, 'WITHHOLDING_TAX', 'Withholding Tax', 'Monthly withholding tax', 'government', 1, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(5, 'HMO', 'HMO Premium', 'Health insurance premium', 'company', 0, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(6, 'UNIFORM', 'Uniform Loan', 'Uniform payment deduction', 'loan', 0, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(7, 'CASH_ADVANCE', 'Cash Advance', 'Salary advance repayment', 'loan', 0, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(8, 'COOP', 'Cooperative', 'Cooperative contribution', 'company', 0, 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45');
...
(1, 'Emergency Room', NULL, 'ER', NULL, NULL, 'Emergency Room Department - 24/7 emergency services', 'Active', '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
...
(7, 'Human Resources', NULL, 'HR', 13, NULL, 'Human Resources Department', 'Active', '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
(8, 'Finance', NULL, 'FIN', 14, NULL, 'Finance and Accounting', 'Active', '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
...
CREATE TABLE `earning_types` (
  ...
  `name` varchar(100) NOT NULL,
  `description` text DEFAULT NULL,
  `category` enum('regular','overtime','incentive','allowance','bonus','other') DEFAULT 'other',
...
INSERT INTO `earning_types` (`id`, `code`, `name`, `description`, `category`, `is_taxable`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'BASIC', 'Basic Salary', 'Base monthly salary', 'regular', 1, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(2, 'RICE', 'Rice Allowance', 'Monthly rice allowance', 'allowance', 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(3, 'MEDICAL', 'Medical Allowance', 'Monthly medical allowance', 'allowance', 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(4, 'TRANS', 'Transportation Allowance', 'Monthly transpo allowance', 'allowance', 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(5, 'NIGHT_DIFF', 'Night Differential', 'Night shift premium', 'allowance', 1, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(6, 'OT_PAY', 'Overtime Pay', 'Overtime compensation', 'overtime', 1, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(7, 'ER_INCENTIVE', 'ER Duty Incentive', 'Emergency room duty incentive', 'incentive', 1, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(8, '13TH_MONTH', '13th Month Pay', '13th month bonus', 'bonus', 0, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(9, 'PERFORMANCE', 'Performance Bonus', 'Performance-based bonus', 'bonus', 1, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45');
...
(2, 2, 'HVL-OPD-002', 'Maria', 'Santos', 'Reyes', '1985-07-22', 'Female', 'Married', 'maria.reyes@hvil.ph', '09182345678', '456 Mabini St', 'Quezon City', 'Metro Manila', '1100', 'Philippines', 'Filipino', 2, 9, 1, 1, NULL, '2020-03-10', 'Active', NULL, '2026-01-01 00:00:00', '2026-03-03 11:34:50'),
(3, 3, 'HVL-NUR-003', 'jo', 'Mercado', 'Santos', '1990-11-08', 'Male', 'Single', 'jose.santos@hvil.ph', '09193456789', '789 Bonifacio St', 'Makati', 'Metro Manila', '1200', 'Philippines', 'Filipino', 3, 2, 1, 1, NULL, '2021-06-01', 'Active', NULL, '2026-01-01 00:00:00', '2026-02-24 09:41:35'),
...
(11, 4, 'HVL-ADM-011', 'Ricardo', 'Alonzo', 'Gonzales', '1975-09-05', 'Male', 'Married', 'ricardo.gonzales@hvil.ph', '09271234567', '8888 Ayala Ave', 'Makati', 'Metro Manila', '1226', 'Philippines', 'Filipino', 11, NULL, 1, 1, NULL, '2018-11-01', 'Active', NULL, '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
(12, NULL, 'HVL-ADM-012', 'Carmen', 'Villanueva', 'Fernando', '1982-02-14', 'Female', 'Married', 'carmen.fernando@hvil.ph', '09282345678', '9999 Buendia Ave', 'Makati', 'Metro Manila', '1233', 'Philippines', 'Filipino', 12, NULL, 1, 1, 11, '2020-05-20', 'Active', NULL, '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
...
(15, NULL, 'HVL-ER-015', 'Michael', 'Angelo', 'Rivera', '1995-10-09', 'Male', 'Single', 'michael.rivera@hvil.ph', '09315678901', '3333 Banawe St', 'Quezon City', 'Metro Manila', '1114', 'Philippines', 'Filipino', 1, 1, 2, 1, NULL, '2024-06-01', 'Active', NULL, '2026-01-01 00:00:00', '2026-01-01 00:00:00');
...
CREATE TABLE `employee_deductions` (
  ...
  `is_mandatory` tinyint(1) DEFAULT 0 COMMENT '1=government mandated (SSS, PhilHealth, etc.)',
  `is_post_tax` tinyint(1) DEFAULT 0 COMMENT '1=deduct after tax, 0=before tax',
  `deduction_date` date NOT NULL,
  `frequency` enum('one-time','monthly','installment') DEFAULT 'one-time',
...
INSERT INTO `employee_deductions` (`id`, `employee_id`, `payroll_run_id`, `deduction_type`, `deduction_code`, `description`, `amount`, `is_mandatory`, `is_post_tax`, `deduction_date`, `frequency`, `total_installments`, `installments_paid`, `remaining_balance`, `reference_id`, `reference_table`, `status`, `approved_by`, `approved_at`, `notes`, `created_at`, `updated_at`) VALUES
(3, 3, 3, 'HMO', 'HMO', 'Intellicare HMO premium', 1500.00, 0, 0, '2026-02-15', 'monthly', 1, 0, 0.00, NULL, NULL, 'active', NULL, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(4, 3, 3, 'CASH_ADVANCE', 'CASH_ADVANCE', 'Salary advance repayment', 2000.00, 0, 0, '2026-02-15', 'installment', 3, 1, 4000.00, NULL, NULL, 'active', NULL, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(5, 4, 3, 'UNIFORM', 'UNIFORM', 'Uniform loan payment', 500.00, 0, 0, '2026-02-15', 'installment', 6, 1, 2500.00, NULL, NULL, 'active', NULL, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(6, 11, 3, 'HMO', 'HMO', 'Maxicare HMO premium', 4000.00, 0, 0, '2026-02-15', 'monthly', 1, 0, 0.00, NULL, NULL, 'active', NULL, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(7, 11, 3, 'COOP', 'COOP', 'Hospital cooperative contribution', 2000.00, 0, 0, '2026-02-15', 'monthly', 1, 0, 0.00, NULL, NULL, 'active', NULL, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53');
...
CREATE TABLE `employee_earnings` (
  ...
  `reference_id` int(11) DEFAULT NULL COMMENT 'Reference to incentive_events, overtime, etc.',
  `reference_table` varchar(50) DEFAULT NULL,
...
INSERT INTO `employee_earnings` (`id`, `employee_id`, `payroll_run_id`, `earning_type`, `earning_code`, `description`, `amount`, `is_taxable`, `earning_date`, `reference_id`, `reference_table`, `status`, `approved_by`, `approved_at`, `notes`, `created_at`, `updated_at`) VALUES
(10, 3, 3, 'NIGHT_DIFF', 'NIGHT_DIFF', 'Night shift differential (4 hours)', 1500.00, 1, '2026-02-15', NULL, NULL, 'approved', 2, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(11, 3, 3, 'OT_PAY', 'OT_PAY', 'Overtime pay (3 hours)', 800.00, 1, '2026-02-15', NULL, NULL, 'approved', 2, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(12, 4, 3, 'NIGHT_DIFF', 'NIGHT_DIFF', 'Night shift differential (8 hours)', 1500.00, 1, '2026-02-15', NULL, NULL, 'approved', 3, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(13, 6, 3, 'OT_PAY', 'OT_PAY', 'Weekend overtime (4 hours)', 950.00, 1, '2026-02-15', NULL, NULL, 'approved', 2, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53'),
(14, 11, 3, 'PERFORMANCE', 'PERFORMANCE', 'Q1 Performance bonus', 15000.00, 1, '2026-02-15', NULL, NULL, 'approved', 1, NULL, NULL, '2026-02-23 02:31:53', '2026-02-23 02:31:53');
...
(4, 4, 'Status Change', '2025-03-15', NULL, NULL, NULL, NULL, NULL, NULL, 28000.00, 30000.00, 'Regularization', 'Approved', 3, '2025-03-15 00:00:00', '2025-03-15 00:00:00', '2026-03-03 10:34:47', 0);
...
(8, 8, 0, 'Semi-Monthly', 15, 30, 'Monthly', 'inactive', NULL, NULL, NULL, NULL, 'Sofia A. Garcia', '8901234567', 'BDO Uniban', 'BDO Unibank', NULL, 'active', '890-123-456-007', '01-2345678-9', '89-012345678-9', '8901-2345-6789', '2026-01-01 00:00:00', '2026-02-23 18:49:14'),
...
(11, 11, 1, 'Semi-Monthly', 15, 30, 'Monthly', 'active', NULL, NULL, NULL, NULL, 'Ricardo A. Gonzales', '1122334455', 'BDO Uniban', 'BDO Unibank', NULL, 'active', '112-233-445-566', '34-5566778-9', '11-223344556-7', '1122-3344-5566', '2026-01-01 00:00:00', '2026-02-23 16:20:26'),
(12, 13, 1, 'Semi-Monthly', 15, 30, 'Monthly', 'active', NULL, NULL, NULL, NULL, 'Ma. Teresa S. Domingo', '2233445566', 'BPI', 'BPI', NULL, 'active', '223-344-556-677', '45-6677889-0', '22-334455667-8', '2233-4455-6677', '2026-01-01 00:00:00', '2026-02-23 16:33:12'),
...
(15, 5, 1, 'Monthly', 15, 30, 'Per Shift', 'active', 'taxable', 'not_enrolled', 'enrolled', 'exempt', 'Pedro Villanueva', '98765430987654', 'miv', 'miv', 'savings', 'active', '0875', '7898765', '45678909876', '87654345678', '2026-02-23 13:21:31', '2026-02-23 13:21:31');
...
CREATE TABLE `employee_salary_components` (
  ...
  `component_type` enum('base','allowance','benefit','earning') NOT NULL DEFAULT 'allowance',
  `amount` decimal(12,2) NOT NULL DEFAULT 0.00,
  `is_taxable` tinyint(1) DEFAULT 1 COMMENT '1=taxable, 0=non-taxable',
  `frequency` enum('monthly','semi-monthly','one-time','annual') DEFAULT 'monthly',
  `effective_from` date NOT NULL,
  `effective_to` date DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `employee_salary_components` (`id`, `employee_id`, `component_code`, `component_name`, `component_type`, `amount`, `is_taxable`, `frequency`, `effective_from`, `effective_to`, `is_active`, `created_at`, `updated_at`) VALUES
(5, 2, 'BASIC', 'Basic Salary', 'base', 65000.00, 1, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(6, 2, 'RICE', 'Rice Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(7, 2, 'MEDICAL', 'Medical Allowance', 'allowance', 1500.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(8, 3, 'BASIC', 'Basic Salary', 'base', 45000.00, 1, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(9, 3, 'RICE', 'Rice Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(10, 3, 'MEDICAL', 'Medical Allowance', 'allowance', 1500.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(11, 4, 'BASIC', 'Basic Salary', 'base', 30000.00, 1, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(12, 4, 'RICE', 'Rice Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(13, 5, 'BASIC', 'Basic Salary', 'base', 48000.00, 1, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(14, 5, 'RICE', 'Rice Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(15, 5, 'MEDICAL', 'Medical Allowance', 'allowance', 1500.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(16, 6, 'BASIC', 'Basic Salary', 'base', 32000.00, 1, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(17, 6, 'RICE', 'Rice Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(18, 7, 'BASIC', 'Basic Salary', 'base', 52000.00, 1, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(19, 7, 'RICE', 'Rice Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(20, 7, 'MEDICAL', 'Medical Allowance', 'allowance', 1500.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(21, 11, 'BASIC', 'Basic Salary', 'base', 120000.00, 1, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(22, 11, 'RICE', 'Rice Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(23, 11, 'MEDICAL', 'Medical Allowance', 'allowance', 1500.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45'),
(24, 11, 'TRANS', 'Transportation Allowance', 'allowance', 2000.00, 0, 'monthly', '2026-01-01', NULL, 1, '2026-02-23 02:29:45', '2026-02-23 02:29:45');
...
(9, 2, 2, 6, 2, 1, 'CLM-2026-009', 'Outpatient Consultation', '2026-02-05', 'HVill OPD', 'Dr. Maria Reyes', 5500.00, NULL, 'approved', NULL, NULL, 'Regular check-up', '2026-01-01 00:00:00', '2026-02-23 12:38:24');
...
CREATE TABLE `holiday_calendar` (
  ...
  `pay_multiplier` decimal(3,2) DEFAULT 2.00 COMMENT '2.0 = 200% pay, 1.3 = 130% pay',
  `is_recurring` tinyint(1) DEFAULT 0 COMMENT '1 = occurs every year',
  `recurring_year` int(4) DEFAULT NULL COMMENT 'NULL if recurring, specific year if one-time',
  `description` text DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT 1,
  `created_by` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `holiday_calendar` (`holiday_id`, `holiday_date`, `holiday_name`, `holiday_type`, `pay_multiplier`, `is_recurring`, `recurring_year`, `description`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
(1, '2026-01-01', 'New Year\'s Day', 'regular', 2.00, 1, NULL, 'First day of the year', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(2, '2026-04-09', 'Araw ng Kagitingan', 'regular', 2.00, 1, NULL, 'Day of Valor', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(3, '2026-05-01', 'Labor Day', 'regular', 2.00, 1, NULL, 'International Workers Day', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(4, '2026-06-12', 'Independence Day', 'regular', 2.00, 1, NULL, 'Philippine Independence', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(5, '2026-08-31', 'National Heroes Day', 'regular', 2.00, 1, NULL, 'Last Monday of August', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(6, '2026-11-30', 'Bonifacio Day', 'regular', 2.00, 1, NULL, 'Andres Bonifacio birthday', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(7, '2026-12-25', 'Christmas Day', 'regular', 2.00, 1, NULL, 'Christmas', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(8, '2026-12-30', 'Rizal Day', 'regular', 2.00, 1, NULL, 'Jose Rizal memorial', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(9, '2026-02-01', 'Chinese New Year', 'special_non_working', 1.30, 0, NULL, 'Year of the Horse', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(10, '2026-02-25', 'EDSA People Power Revolution', 'special_non_working', 1.30, 1, NULL, 'EDSA Anniversary', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(11, '2026-04-02', 'Maundy Thursday', 'special_non_working', 1.30, 1, NULL, 'Holy Week', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(12, '2026-04-03', 'Good Friday', 'special_non_working', 1.30, 1, NULL, 'Holy Week', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(13, '2026-04-04', 'Black Saturday', 'special_non_working', 1.30, 1, NULL, 'Holy Week', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(14, '2026-08-21', 'Ninoy Aquino Day', 'special_non_working', 1.30, 1, NULL, 'Benigno Aquino Jr. memorial', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(15, '2026-11-01', 'All Saints Day', 'special_non_working', 1.30, 1, NULL, 'Day of the Dead', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(16, '2026-11-02', 'All Souls Day', 'special_non_working', 1.30, 1, NULL, 'Day of the Dead', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(17, '2026-12-08', 'Feast of the Immaculate Conception', 'special_non_working', 1.30, 1, NULL, 'Patronal feast', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(18, '2026-12-24', 'Christmas Eve', 'special_non_working', 1.30, 0, NULL, 'Special non-working', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38'),
(19, '2026-12-31', 'Last Day of the Year', 'special_non_working', 1.30, 1, NULL, 'New Year\'s Eve', 1, 1, '2026-02-23 15:47:38', '2026-02-23 15:47:38');
...
(11, 'Hospital Administrator', 'Chief Operating Officer', NULL, 9, 'Active', '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
(12, 'Administrative Officer', 'Administrative Support', NULL, 6, 'Active', '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
...
(4, 7, '$2y$10$mKfIP6dp1qB1bhBE/z45n.gt3X8l7U7coCxA4tIjcGMn2xzavS6b6', '2026-02-23 16:37:05', 0, 1, '2026-02-23 08:27:05'),
(5, 7, '$2y$10$Ffh0FhYZU7vu8/Et06Mc.eyRVxQ0FIAh5B.QGFAvoYPJmB1jUJ4oO', '2026-02-23 22:57:40', 0, 1, '2026-02-23 14:47:40'),
(6, 7, '$2y$10$YrB2wsxW7TCvspu7fYGpXOaBzPrMHBbuTNJaC4R9vhaJFo99DXhjm', '2026-02-24 02:39:03', 0, 1, '2026-02-23 18:29:03'),
(7, 7, '$2y$10$4zNmWTDw/U6Ag.XT2pk0aeZlIMaUso7i2hupVBDWTi.f.T81ceyLu', '2026-02-24 02:39:22', 0, 1, '2026-02-23 18:29:22'),
(8, 7, '$2y$10$YTEygjztrJPRA4Bzm/ox5u6Yf3nIw4VlGd1w5w0JIbFWBWTak33ey', '2026-02-24 10:14:54', 0, 1, '2026-02-24 02:04:54'),
(9, 7, '$2y$10$h2X/2h3UBGbNDNmDptvBreVJS2uSs6QqjHLgnwmSsdkKy0.nwHfG.', '2026-02-24 17:50:04', 0, 1, '2026-02-24 09:40:04'),
(10, 7, '$2y$10$a/bI/qrMtCvKD8JO9prksehpqKIrXxQpQgDI2r/bfEgltQGWyP.3G', '2026-02-24 17:50:06', 0, 1, '2026-02-24 09:40:06'),
(11, 7, '$2y$10$Ah1JXIECqv6wfDuLqb9nK.SmHFYLaRzfCUTdevh0Jevo1FFRx8NLC', '2026-02-24 20:02:17', 0, 1, '2026-02-24 11:52:17'),
(12, 7, '$2y$10$PaLeSxQXulbs2kymoFfLKOXlL1/8wFi0FimMcIxg.jR5h7ax36uy2', '2026-03-03 13:38:11', 0, 1, '2026-03-03 05:28:11'),
(13, 7, '$2y$10$/dbs0VVeafYsV39rM2URDuOYI9HPAXAAZpCizvQMUIHdO3OYqZx0K', '2026-03-03 15:45:45', 0, 1, '2026-03-03 07:35:45'),
(14, 7, '$2y$10$YsH09NMIJTF8Yh1MUu3.WOZbQdsrpcFcvmsYg1VbTaWkTvUuZgNye', '2026-03-03 18:42:37', 0, 1, '2026-03-03 10:32:37'),
(15, 7, '$2y$10$cfy8HnmFJauhc7ngk4brG.3Fz8EaOLdl5CXqTD2gGyMkQ117FFkhG', '2026-03-03 19:11:01', 0, 1, '2026-03-03 11:01:01'),
(16, 7, '$2y$10$o.b61FbecVgm48QQL4OvXOScxJPEvJF5pwtgklmcYn5qHZM1gGOue', '2026-03-03 19:40:24', 0, 1, '2026-03-03 11:30:24');
...
(1, 7, '::1', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-23 08:27:05'),
(2, 7, '::1', 'otp_verification', 'success', 'OTP verified successfully', '2026-02-23 08:27:23'),
(3, 7, '192.168.1.10', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-23 14:47:40'),
(4, 7, '::1', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-23 18:29:03'),
(5, 7, '::1', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-23 18:29:22'),
(6, 7, '::1', 'otp_verification', 'success', 'OTP verified successfully', '2026-02-23 18:35:22'),
(7, 7, '::1', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-24 02:04:54'),
(8, 7, '::1', 'otp_verification', 'success', 'OTP verified successfully', '2026-02-24 02:05:36'),
(9, 7, '209.35.161.52', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-24 09:40:04'),
(10, 7, '209.35.161.52', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-24 09:40:06'),
(11, 7, '209.35.161.52', 'otp_verification', 'success', 'OTP verified successfully', '2026-02-24 09:40:44'),
(12, 7, '175.158.203.39', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-02-24 11:52:17'),
(13, 7, '175.158.203.39', 'otp_verification', 'success', 'OTP verified successfully', '2026-02-24 11:52:35'),
(14, 7, '112.203.51.44', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-03-03 05:28:11'),
(15, 7, '112.203.51.44', 'otp_verification', 'success', 'OTP verified successfully', '2026-03-03 05:28:31'),
(16, 7, '112.200.110.9', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-03-03 07:35:45'),
(17, 7, '112.200.110.9', 'otp_verification', 'success', 'OTP verified successfully', '2026-03-03 07:36:19'),
(18, 7, '209.35.164.221', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-03-03 10:32:37'),
(19, 7, '209.35.164.221', 'otp_verification', 'success', 'OTP verified successfully', '2026-03-03 10:33:28'),
(20, 7, '209.35.164.221', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-03-03 11:01:01'),
(21, 7, '209.35.164.221', 'otp_verification', 'success', 'OTP verified successfully', '2026-03-03 11:01:26'),
(22, 7, '209.35.164.221', 'otp_generated', 'success', 'johnpaulaustria321@gmail.com', '2026-03-03 11:30:24'),
(23, 7, '209.35.164.221', 'otp_verification', 'success', 'OTP verified successfully', '2026-03-03 11:33:03');
...
CREATE TABLE `payroll_calendar` (
  ...
  `period_number` int(1) NOT NULL COMMENT '1 = first half, 2 = second half',
  `period_name` varchar(50) NOT NULL,
  `cutoff_start` date NOT NULL,
  `cutoff_end` date NOT NULL,
  `pay_date` date NOT NULL,
  `payroll_frequency` enum('weekly','semi-monthly','monthly') DEFAULT 'semi-monthly',
  `status` enum('pending','processing','completed','closed') DEFAULT 'pending',
  `is_holiday_period` tinyint(1) DEFAULT 0,
  `holiday_pay_multiplier` decimal(3,2) DEFAULT 1.00,
  `notes` text DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
...
INSERT INTO `payroll_calendar` (`calendar_id`, `year`, `month`, `period_number`, `period_name`, `cutoff_start`, `cutoff_end`, `pay_date`, `payroll_frequency`, `status`, `is_holiday_period`, `holiday_pay_multiplier`, `notes`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 2026, 1, 1, 'January 1-15, 2026', '2026-01-01', '2026-01-15', '2026-01-20', 'semi-monthly', 'closed', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(2, 2026, 1, 2, 'January 16-31, 2026', '2026-01-16', '2026-01-31', '2026-02-05', 'semi-monthly', 'closed', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(3, 2026, 2, 1, 'February 1-15, 2026', '2026-02-01', '2026-02-15', '2026-02-20', 'semi-monthly', 'completed', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(4, 2026, 2, 2, 'February 16-28, 2026', '2026-02-16', '2026-02-28', '2026-03-05', 'semi-monthly', 'processing', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(5, 2026, 3, 1, 'March 1-15, 2026', '2026-03-01', '2026-03-15', '2026-03-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(6, 2026, 3, 2, 'March 16-31, 2026', '2026-03-16', '2026-03-31', '2026-04-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(7, 2026, 4, 1, 'April 1-15, 2026', '2026-04-01', '2026-04-15', '2026-04-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(8, 2026, 4, 2, 'April 16-30, 2026', '2026-04-16', '2026-04-30', '2026-05-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(9, 2026, 5, 1, 'May 1-15, 2026', '2026-05-01', '2026-05-15', '2026-05-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(10, 2026, 5, 2, 'May 16-31, 2026', '2026-05-16', '2026-05-31', '2026-06-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(11, 2026, 6, 1, 'June 1-15, 2026', '2026-06-01', '2026-06-15', '2026-06-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(12, 2026, 6, 2, 'June 16-30, 2026', '2026-06-16', '2026-06-30', '2026-07-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(13, 2026, 7, 1, 'July 1-15, 2026', '2026-07-01', '2026-07-15', '2026-07-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(14, 2026, 7, 2, 'July 16-31, 2026', '2026-07-16', '2026-07-31', '2026-08-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(15, 2026, 8, 1, 'August 1-15, 2026', '2026-08-01', '2026-08-15', '2026-08-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(16, 2026, 8, 2, 'August 16-31, 2026', '2026-08-16', '2026-08-31', '2026-09-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(17, 2026, 9, 1, 'September 1-15, 2026', '2026-09-01', '2026-09-15', '2026-09-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(18, 2026, 9, 2, 'September 16-30, 2026', '2026-09-16', '2026-09-30', '2026-10-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(19, 2026, 10, 1, 'October 1-15, 2026', '2026-10-01', '2026-10-15', '2026-10-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(20, 2026, 10, 2, 'October 16-31, 2026', '2026-10-16', '2026-10-31', '2026-11-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(21, 2026, 11, 1, 'November 1-15, 2026', '2026-11-01', '2026-11-15', '2026-11-20', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(22, 2026, 11, 2, 'November 16-30, 2026', '2026-11-16', '2026-11-30', '2026-12-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(23, 2026, 12, 1, 'December 1-15, 2026', '2026-12-01', '2026-12-15', '2026-12-18', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55'),
(24, 2026, 12, 2, 'December 16-31, 2026', '2026-12-16', '2026-12-31', '2027-01-05', 'semi-monthly', 'pending', 0, 1.00, NULL, 1, '2026-02-23 15:46:55', '2026-02-23 15:46:55');

-- --------------------------------------------------------

--
-- Table structure for table `payroll_calendar_exceptions`
--

CREATE TABLE `payroll_calendar_exceptions` (
  ...
  `exception_type` enum('weekend','holiday','bank_closure','system_issue','other') DEFAULT 'other',
  `approved_by` int(11) DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL,
  `notes` text DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Dumping data for table `payroll_calendar_exceptions`
--

INSERT INTO `payroll_calendar_exceptions` (`exception_id`, `calendar_id`, `original_pay_date`, `adjusted_pay_date`, `exception_reason`, `exception_type`, `approved_by`, `approved_at`, `notes`, `created_at`, `updated_at`) VALUES
(1, 11, '2026-06-20', '2026-06-19', 'Pay date falls on Saturday, moved to Friday', 'weekend', 1, NULL, NULL, '2026-02-23 15:48:33', '2026-02-23 15:48:33'),
(2, 17, '2026-09-20', '2026-09-18', 'Pay date falls on Sunday, moved to Friday', 'weekend', 1, NULL, NULL, '2026-02-23 15:48:33', '2026-02-23 15:48:33'),
(3, 23, '2026-12-20', '2026-12-18', 'Pay date falls on Sunday, moved to Friday before Christmas', 'weekend', 1, NULL, NULL, '2026-02-23 15:48:33', '2026-02-23 15:48:33');
...
INSERT INTO `payroll_runs` (`id`, `period_name`, `calendar_id`, `start_date`, `end_date`, `pay_date`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'January 2026 Period 1', NULL, '2026-01-01', '2026-01-15', '2026-01-20', 'Closed', 14, '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
(2, 'January 2026 Period 2', NULL, '2026-01-16', '2026-01-31', '2026-02-05', 'Closed', 14, '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
(3, 'February 2026 Period 1', NULL, '2026-02-01', '2026-02-15', '2026-02-20', 'Closed', 14, '2026-02-01 00:00:00', '2026-02-01 00:00:00'),
(4, 'February 2026 Period 2', NULL, '2026-02-16', '2026-02-28', '2026-03-05', 'Draft', 14, '2026-02-01 00:00:00', '2026-02-01 00:00:00'),
(5, 'January 2026 Payroll', NULL, '2026-01-01', '2026-01-31', '2026-02-05', 'Closed', 14, '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
(6, 'February 2026 Payroll', NULL, '2026-02-01', '2026-02-28', '2026-03-05', 'Draft', 14, '2026-02-01 00:00:00', '2026-02-01 00:00:00'),
(7, 'Payroll Period: Feb 1, 2026 - Feb 15, 2026', NULL, '2026-02-01', '2026-02-15', '2026-02-20', 'Processed', NULL, '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(8, 'Payroll Period: Mar 5, 2026 - Mar 20, 2026', NULL, '2026-03-05', '2026-03-20', '2026-03-25', 'Processed', NULL, '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(9, 'Payroll Period: Feb 15, 2026 - Mar 1, 2026', NULL, '2026-02-15', '2026-03-01', '2026-03-05', 'Processed', NULL, '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(10, 'andrew', NULL, '2026-03-03', '2026-12-03', '2026-03-15', 'Archived', 7, '2026-03-03 11:37:03', '2026-03-03 11:37:39');
...
(19, 7, 3, 45000.00, 0.00, 45000.00, 3958.50, 41041.50, 750.00, 1633.50, 1125.00, 450.00, 'PS-7-3-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(20, 7, 4, 30000.00, 0.00, 30000.00, 2139.00, 27861.00, 0.00, 1089.00, 750.00, 300.00, 'PS-7-4-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(21, 7, 5, 48000.00, 0.00, 48000.00, 4322.40, 43677.60, 900.00, 1742.40, 1200.00, 480.00, 'PS-7-5-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(22, 7, 6, 32000.00, 0.00, 32000.00, 2381.60, 29618.40, 100.00, 1161.60, 800.00, 320.00, 'PS-7-6-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(23, 7, 7, 52000.00, 0.00, 52000.00, 4351.35, 47648.65, 643.75, 1887.60, 1300.00, 520.00, 'PS-7-7-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(24, 7, 8, 35000.00, 0.00, 35000.00, 2745.50, 32254.50, 250.00, 1270.50, 875.00, 350.00, 'PS-7-8-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(25, 7, 9, 55000.00, 0.00, 55000.00, 5165.25, 49834.75, 1243.75, 1996.50, 1375.00, 550.00, 'PS-7-9-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(26, 7, 10, 38000.00, 0.00, 38000.00, 3109.40, 34890.60, 400.00, 1379.40, 950.00, 380.00, 'PS-7-10-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(27, 7, 11, 120000.00, 0.00, 120000.00, 17799.75, 102200.25, 9243.75, 4356.00, 3000.00, 1200.00, 'PS-7-11-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(28, 7, 12, 75000.00, 0.00, 75000.00, 10591.25, 64408.75, 5243.75, 2722.50, 1875.00, 750.00, 'PS-7-12-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(29, 7, 13, 65000.00, 0.00, 65000.00, 7878.25, 57121.75, 3243.75, 2359.50, 1625.00, 650.00, 'PS-7-13-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(30, 7, 14, 80000.00, 0.00, 80000.00, 11947.75, 68052.25, 6243.75, 2904.00, 2000.00, 800.00, 'PS-7-14-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(31, 7, 15, 65000.00, 0.00, 65000.00, 7878.25, 57121.75, 3243.75, 2359.50, 1625.00, 650.00, 'PS-7-15-202602', 'Processed', '2026-02-23 13:41:27', '2026-02-23 13:41:27'),
(32, 8, 3, 45000.00, 0.00, 45000.00, 3958.50, 41041.50, 750.00, 1633.50, 1125.00, 450.00, 'PS-8-3-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(33, 8, 4, 30000.00, 0.00, 30000.00, 2139.00, 27861.00, 0.00, 1089.00, 750.00, 300.00, 'PS-8-4-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(34, 8, 5, 48000.00, 0.00, 48000.00, 4322.40, 43677.60, 900.00, 1742.40, 1200.00, 480.00, 'PS-8-5-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(35, 8, 6, 32000.00, 0.00, 32000.00, 2381.60, 29618.40, 100.00, 1161.60, 800.00, 320.00, 'PS-8-6-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(36, 8, 7, 52000.00, 0.00, 52000.00, 4351.35, 47648.65, 643.75, 1887.60, 1300.00, 520.00, 'PS-8-7-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(37, 8, 8, 35000.00, 0.00, 35000.00, 2745.50, 32254.50, 250.00, 1270.50, 875.00, 350.00, 'PS-8-8-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(38, 8, 9, 55000.00, 0.00, 55000.00, 5165.25, 49834.75, 1243.75, 1996.50, 1375.00, 550.00, 'PS-8-9-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(39, 8, 10, 38000.00, 0.00, 38000.00, 3109.40, 34890.60, 400.00, 1379.40, 950.00, 380.00, 'PS-8-10-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(40, 8, 11, 120000.00, 0.00, 120000.00, 17799.75, 102200.25, 9243.75, 4356.00, 3000.00, 1200.00, 'PS-8-11-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(41, 8, 12, 75000.00, 0.00, 75000.00, 10591.25, 64408.75, 5243.75, 2722.50, 1875.00, 750.00, 'PS-8-12-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(42, 8, 13, 65000.00, 0.00, 65000.00, 7878.25, 57121.75, 3243.75, 2359.50, 1625.00, 650.00, 'PS-8-13-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(43, 8, 14, 80000.00, 0.00, 80000.00, 11947.75, 68052.25, 6243.75, 2904.00, 2000.00, 800.00, 'PS-8-14-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(44, 8, 15, 65000.00, 0.00, 65000.00, 7878.25, 57121.75, 3243.75, 2359.50, 1625.00, 650.00, 'PS-8-15-202602', 'Processed', '2026-02-23 19:39:00', '2026-02-23 19:39:00'),
(45, 9, 3, 45000.00, 0.00, 45000.00, 3958.50, 41041.50, 750.00, 1633.50, 1125.00, 450.00, 'PS-9-3-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(46, 9, 4, 30000.00, 0.00, 30000.00, 2139.00, 27861.00, 0.00, 1089.00, 750.00, 300.00, 'PS-9-4-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(47, 9, 5, 48000.00, 0.00, 48000.00, 4322.40, 43677.60, 900.00, 1742.40, 1200.00, 480.00, 'PS-9-5-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(48, 9, 6, 32000.00, 0.00, 32000.00, 2381.60, 29618.40, 100.00, 1161.60, 800.00, 320.00, 'PS-9-6-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(49, 9, 7, 52000.00, 0.00, 52000.00, 4351.35, 47648.65, 643.75, 1887.60, 1300.00, 520.00, 'PS-9-7-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(50, 9, 8, 35000.00, 0.00, 35000.00, 2745.50, 32254.50, 250.00, 1270.50, 875.00, 350.00, 'PS-9-8-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(51, 9, 9, 55000.00, 0.00, 55000.00, 5165.25, 49834.75, 1243.75, 1996.50, 1375.00, 550.00, 'PS-9-9-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(52, 9, 10, 38000.00, 0.00, 38000.00, 3109.40, 34890.60, 400.00, 1379.40, 950.00, 380.00, 'PS-9-10-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(53, 9, 11, 120000.00, 0.00, 120000.00, 17799.75, 102200.25, 9243.75, 4356.00, 3000.00, 1200.00, 'PS-9-11-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(54, 9, 12, 75000.00, 0.00, 75000.00, 10591.25, 64408.75, 5243.75, 2722.50, 1875.00, 750.00, 'PS-9-12-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(55, 9, 13, 65000.00, 0.00, 65000.00, 7878.25, 57121.75, 3243.75, 2359.50, 1625.00, 650.00, 'PS-9-13-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(56, 9, 14, 80000.00, 0.00, 80000.00, 11947.75, 68052.25, 6243.75, 2904.00, 2000.00, 800.00, 'PS-9-14-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(57, 9, 15, 65000.00, 0.00, 65000.00, 7878.25, 57121.75, 3243.75, 2359.50, 1625.00, 650.00, 'PS-9-15-202602', 'Processed', '2026-02-24 09:44:59', '2026-02-24 09:44:59'),
(58, 10, 2, 65000.00, 0.00, 65000.00, 0.00, 65000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(59, 10, 3, 45000.00, 0.00, 45000.00, 0.00, 45000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(60, 10, 4, 30000.00, 0.00, 30000.00, 0.00, 30000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(61, 10, 5, 48000.00, 0.00, 48000.00, 0.00, 48000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(62, 10, 6, 32000.00, 0.00, 32000.00, 0.00, 32000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(63, 10, 7, 52000.00, 0.00, 52000.00, 0.00, 52000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(64, 10, 8, 35000.00, 0.00, 35000.00, 0.00, 35000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(65, 10, 9, 55000.00, 0.00, 55000.00, 0.00, 55000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(66, 10, 10, 38000.00, 0.00, 38000.00, 0.00, 38000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(67, 10, 11, 120000.00, 0.00, 120000.00, 0.00, 120000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(68, 10, 12, 75000.00, 0.00, 75000.00, 0.00, 75000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(69, 10, 13, 65000.00, 0.00, 65000.00, 0.00, 65000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(70, 10, 14, 80000.00, 0.00, 80000.00, 0.00, 80000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(71, 10, 15, 65000.00, 0.00, 65000.00, 0.00, 65000.00, 0.00, 0.00, 0.00, 0.00, NULL, 'Processed', '2026-03-03 11:37:03', '2026-03-03 11:37:03');
...
INSERT INTO `payslip_records` (`id`, `payroll_run_id`, `employee_id`, `gross_pay`, `total_deductions`, `net_pay`, `payslip_number`, `generated_at`, `generated_by`, `pdf_path`, `download_count`, `last_download_at`, `status`, `created_at`, `updated_at`) VALUES
(1, 8, 11, 120000.00, 17799.75, 102200.25, 'PS-20260224-8-11', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(2, 8, 12, 75000.00, 10591.25, 64408.75, 'PS-20260224-8-12', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(3, 8, 15, 65000.00, 7878.25, 57121.75, 'PS-20260224-8-15', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(4, 8, 14, 80000.00, 11947.75, 68052.25, 'PS-20260224-8-14', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(5, 8, 13, 65000.00, 7878.25, 57121.75, 'PS-20260224-8-13', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(6, 8, 5, 48000.00, 4322.40, 43677.60, 'PS-20260224-8-5', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(7, 8, 6, 32000.00, 2381.60, 29618.40, 'PS-20260224-8-6', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(8, 8, 3, 45000.00, 3958.50, 41041.50, 'PS-20260224-8-3', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(9, 8, 4, 30000.00, 2139.00, 27861.00, 'PS-20260224-8-4', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(10, 8, 9, 55000.00, 5165.25, 49834.75, 'PS-20260224-8-9', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(11, 8, 10, 38000.00, 3109.40, 34890.60, 'PS-20260224-8-10', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(12, 8, 7, 52000.00, 4351.35, 47648.65, 'PS-20260224-8-7', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(13, 8, 8, 35000.00, 2745.50, 32254.50, 'PS-20260224-8-8', '2026-02-23 19:48:20', 7, NULL, 0, NULL, 'generated', '2026-02-23 19:48:20', '2026-02-23 19:48:20'),
(14, 7, 11, 120000.00, 17799.75, 102200.25, 'PS-20260224-7-11', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(15, 7, 12, 75000.00, 10591.25, 64408.75, 'PS-20260224-7-12', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(16, 7, 15, 65000.00, 7878.25, 57121.75, 'PS-20260224-7-15', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(17, 7, 14, 80000.00, 11947.75, 68052.25, 'PS-20260224-7-14', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(18, 7, 13, 65000.00, 7878.25, 57121.75, 'PS-20260224-7-13', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(19, 7, 5, 48000.00, 4322.40, 43677.60, 'PS-20260224-7-5', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(20, 7, 6, 32000.00, 2381.60, 29618.40, 'PS-20260224-7-6', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(21, 7, 3, 45000.00, 3958.50, 41041.50, 'PS-20260224-7-3', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(22, 7, 4, 30000.00, 2139.00, 27861.00, 'PS-20260224-7-4', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(23, 7, 9, 55000.00, 5165.25, 49834.75, 'PS-20260224-7-9', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(24, 7, 10, 38000.00, 3109.40, 34890.60, 'PS-20260224-7-10', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(25, 7, 7, 52000.00, 4351.35, 47648.65, 'PS-20260224-7-7', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(26, 7, 8, 35000.00, 2745.50, 32254.50, 'PS-20260224-7-8', '2026-02-24 12:14:52', 7, NULL, 0, NULL, 'generated', '2026-02-24 12:14:52', '2026-02-24 12:14:52'),
(27, 10, 2, 65000.00, 0.00, 65000.00, 'PS-10-2', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(28, 10, 3, 45000.00, 0.00, 45000.00, 'PS-10-3', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(29, 10, 4, 30000.00, 0.00, 30000.00, 'PS-10-4', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(30, 10, 5, 48000.00, 0.00, 48000.00, 'PS-10-5', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(31, 10, 6, 32000.00, 0.00, 32000.00, 'PS-10-6', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(32, 10, 7, 52000.00, 0.00, 52000.00, 'PS-10-7', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(33, 10, 8, 35000.00, 0.00, 35000.00, 'PS-10-8', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(34, 10, 9, 55000.00, 0.00, 55000.00, 'PS-10-9', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(35, 10, 10, 38000.00, 0.00, 38000.00, 'PS-10-10', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(36, 10, 11, 120000.00, 0.00, 120000.00, 'PS-10-11', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(37, 10, 12, 75000.00, 0.00, 75000.00, 'PS-10-12', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(38, 10, 13, 65000.00, 0.00, 65000.00, 'PS-10-13', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(39, 10, 14, 80000.00, 0.00, 80000.00, 'PS-10-14', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03'),
(40, 10, 15, 65000.00, 0.00, 65000.00, 'PS-10-15', '2026-03-03 11:37:03', NULL, NULL, 0, NULL, 'generated', '2026-03-03 11:37:03', '2026-03-03 11:37:03');
...
(7, 'mic', 'mic', '', 'Active', '2026-02-23 14:17:38', '2026-02-23 14:17:38');
...
(1, 'juan.cruz', 'juan.cruz@hvil.ph', '$2y$10$k1PqX1E56lpDb304jZwD.e9usMgVBUaL1dcUEkjcVZhKe7vY9OcKy', 'John Paul', 'Austria', 'John Paul Austria', 'admin', 'active', '2026-01-01 00:00:00', '2026-02-23 08:25:49'),
(2, 'maria.reyes', 'maria.reyes@hvil.ph', '$2y$10$fAsfERT.6UQrsOsoKJQyZOxw2RYuLA7eyTSJol8DcQiC1PogIdBFa', 'HR', 'Chief', 'HR Chief', 'hr_chief', 'active', '2026-01-01 00:00:00', '2026-02-23 08:25:49'),
(3, 'jose.santos', 'jose.santos@hvil.ph', '$2y$10$YourNewHashHere', 'Lipe', 'Juje', 'Lipe Juje', 'admin', 'active', '2026-01-01 00:00:00', '2026-02-23 14:54:57'),
...
(7, 'admin', 'johnpaulaustria321@gmail.com', '$2y$10$k1PqX1E56lpDb304jZwD.e9usMgVBUaL1dcUEkjcVZhKe7vY9OcKy', 'John Paul', 'Austria', 'John Paul Austria', 'admin', 'active', '2026-01-01 00:00:00', '2026-02-23 08:26:42'),
(10, 'hrchief', 'itachiuchiha10012@gmail.com', '$2y$10$fAsfERT.6UQrsOsoKJQyZOxw2RYuLA7eyTSJol8DcQiC1PogIdBFa', 'HR', 'Chief', 'HR Chief', 'hr_chief', 'active', '2026-02-23 08:25:49', '2026-02-23 08:25:49'),
(12, 'lipejuje', 'lipejuje@gmail.com', '$2y$10$l9MrbUcR8vzWxdXEa2D8leR03HF0rF9dI9/BUjjocPlugkZRRttUO', 'Lipe', 'Juje', 'Lipe Juje', 'admin', 'active', '2026-02-23 14:54:57', '2026-02-23 14:54:57');
...
ALTER TABLE `employee_salary_components`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_employee_component` (`employee_id`,`component_code`,`effective_from`),
  ADD KEY `idx_employee_id` (`employee_id`),
  ADD KEY `idx_component_type` (`component_type`),
  ADD KEY `idx_is_active` (`is_active`),
  ADD KEY `idx_effective_date` (`effective_from`,`effective_to`);
...
ALTER TABLE `payroll_calendar`
  ...
  ADD UNIQUE KEY `unique_period` (`year`,`month`,`period_number`),
  ADD KEY `idx_year_month` (`year`,`month`),
  ADD KEY `idx_cutoff_dates` (`cutoff_start`,`cutoff_end`),
  ADD KEY `idx_pay_date` (`pay_date`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `created_by` (`created_by`);

--
-- Indexes for table `payroll_calendar_exceptions`
--
ALTER TABLE `payroll_calendar_exceptions`
  ADD PRIMARY KEY (`exception_id`),
  ADD KEY `idx_calendar_id` (`calendar_id`),
  ADD KEY `idx_original_date` (`original_pay_date`),
  ADD KEY `idx_adjusted_date` (`adjusted_pay_date`),
  ADD KEY `approved_by` (`approved_by`);
...
--
ALTER TABLE `payroll_calendar`
  MODIFY `calendar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `payroll_calendar_exceptions`
--
ALTER TABLE `payroll_calendar_exceptions`
...
--
ALTER TABLE `employee_deductions`
  ADD CONSTRAINT `employee_deductions_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `employee_deductions_ibfk_2` FOREIGN KEY (`payroll_run_id`) REFERENCES `payroll_runs` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `employee_deductions_ibfk_3` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `employee_earnings`
  ADD CONSTRAINT `employee_earnings_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `employee_earnings_ibfk_2` FOREIGN KEY (`payroll_run_id`) REFERENCES `payroll_runs` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `employee_earnings_ibfk_3` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `employee_salary_components`
  ADD CONSTRAINT `employee_salary_components_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `holiday_calendar`
  ADD CONSTRAINT `holiday_calendar_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
-- Constraints for table `payroll_calendar`
--
ALTER TABLE `payroll_calendar`
  ADD CONSTRAINT `payroll_calendar_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `payroll_calendar_exceptions`
--
ALTER TABLE `payroll_calendar_exceptions`
  ADD CONSTRAINT `payroll_calendar_exceptions_ibfk_1` FOREIGN KEY (`calendar_id`) REFERENCES `payroll_calendar` (`calendar_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `payroll_calendar_exceptions_ibfk_2` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `payroll_runs`
  ADD CONSTRAINT `payroll_runs_ibfk_1` FOREIGN KEY (`calendar_id`) REFERENCES `payroll_calendar` (`calendar_id`) ON DELETE SET NULL;
